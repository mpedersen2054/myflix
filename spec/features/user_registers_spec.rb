...
feature "User registers", { js: true, vcr: true } do
  ...
  scenario "with valid user info and valid card" do
    ...
    expect(page).to have_content "Thank you for registering with MattFlix. Please sign in now."
  end
...
def fill_in_valid_user_info
  fill_in "Email Address", with: "matt@example.com"
  fill_in "Password", with: "password"
  fill_in "Full Name", with: "Matt Peder"
end
